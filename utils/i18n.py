...
_STRINGS = {
    ...
    "assistant_card": {"zh": "助手基础", "en": "Assistant"},
    "assistant_name_label": {"zh": "助手名称", "en": "Assistant name"},
    "assistant_size_label": {"zh": "体型", "en": "Size"},
    ...
    "add_assistant_folder_label": {"zh": "助手文件夹名称", "en": "Assistant folder name"},
    "add_assistant_folder_placeholder": {"zh": "英文或数字，如 p_bot、my_assistant", "en": "Letters/numbers, e.g. p_bot, my_assistant"},
    "add_assistant_folder_tooltip": {"zh": "仅英文、数字、下划线，且必须以英文字母开头", "en": "Letters, digits, underscore only; must start with a letter"},
    "add_assistant_name_label": {"zh": "助手名称", "en": "Assistant name"},
    "add_assistant_name_placeholder": {"zh": "显示用名称，英文开头", "en": "Display name, start with letter"},
    "add_assistant_bot_id_label": {"zh": "助手 ID（自动）", "en": "Assistant ID (auto)"},
    "add_assistant_description_label": {"zh": "助手介绍", "en": "Description"},
    "add_assistant_description_placeholder": {"zh": "可填写中文介绍", "en": "Description, Chinese allowed"},
    "add_assistant_sprites_card": {"zh": "表情图集", "en": "Sprite sets"},
    "add_assistant_sprites_hint": {"zh": "每个表情可选 1.png～30.png，必须从 1 开始连续；多选后复制到对应目录。", "en": "Each set: 1.png to 30.png, must start at 1 and be continuous."},
    "add_assistant_select_images": {"zh": "选择图片", "en": "Select images"},
    "add_assistant_selected_fmt": {"zh": "已选 %d 张", "en": "%d selected"},
    "add_assistant_ok": {"zh": "确定添加", "en": "Add"},
    "add_assistant_validation_folder_no_chinese": {"zh": "助手文件夹名称不能包含汉字，且必须以英文字母开头", "en": "Folder name: no Chinese, must start with a letter"},
    "add_assistant_validation_name_no_chinese": {"zh": "助手名称不能包含汉字，且必须以英文字母开头", "en": "Assistant name: no Chinese, must start with a letter"},
    "add_assistant_validation_folder_empty": {"zh": "请填写助手文件夹名称", "en": "Please enter folder name"},
    "add_assistant_validation_name_empty": {"zh": "请填写助手名称", "en": "Please enter assistant name"},
    "add_assistant_validation_folder_exists": {"zh": "该文件夹已存在，请换一个名称", "en": "Folder already exists, use another name"},
    "add_assistant_validation_sprites_continuous": {"zh": "图片必须为 1.png、2.png、… 连续编号，且从 1 开始（不能从 2.png 开头）", "en": "Files must be 1.png, 2.png, ... continuous, starting from 1"},
    "add_assistant_validation_sprites_max": {"zh": "每个表情最多 30 张图片", "en": "Max 30 images per set"},
    "add_assistant_success": {"zh": "助手已添加，可在右键菜单「选择助手」中切换", "en": "Assistant added. Switch via right-click menu > Select assistant"},
    "add_assistant_failed": {"zh": "添加失败", "en": "Add failed"},
    "edit_assistant_btn": {"zh": "编辑助手", "en": "Edit assistant"},
    "edit_assistant_tooltip": {"zh": "修改助手资料或删除助手", "en": "Edit or delete assistant"},
    "edit_assistant_title": {"zh": "编辑助手", "en": "Edit assistant"},
    "edit_assistant_select_label": {"zh": "选择要编辑的助手", "en": "Select assistant to edit"},
    "edit_assistant_folder_readonly": {"zh": "助手文件夹（不可改）", "en": "Assistant folder (read-only)"},
    "edit_assistant_save": {"zh": "保存修改", "en": "Save"},
    "edit_assistant_delete": {"zh": "删除助手", "en": "Delete assistant"},
    "edit_assistant_delete_confirm": {"zh": "确定要删除该助手吗？删除后不可恢复。", "en": "Delete this assistant? This cannot be undone."},
    "edit_assistant_deleted": {"zh": "助手已删除", "en": "Assistant deleted"},
    "edit_assistant_saved": {"zh": "助手资料已保存", "en": "Assistant saved"},
    "edit_assistant_overwrite_confirm": {"zh": "以下表情文件夹中已有图片，保存将覆盖：%s。是否继续？", "en": "These sprite folders already have images and will be overwritten: %s. Continue?"},
    "edit_assistant_no_assistant": {"zh": "请先选择要编辑的助手", "en": "Please select an assistant to edit"},
    "edit_assistant_no_assistants": {"zh": "暂无助手，请先添加助手", "en": "No assistants. Add a character first."},
    ...
    "select_assistant_menu": {"zh": "选择助手", "en": "Select assistant"},
    ...
    "assistant_default_name": {"zh": "助手", "en": "Assistant"},
    ...
    "session_key_placeholder": {"zh": "如 agent:work:claw_assistant", "en": "e.g. agent:work:claw_assistant"},
    "session_key_tooltip": {"zh": "自动互动使用的 sessionKey，如 agent:work:claw_assistant；可从会话管理窗口右键会话复制", "en": "SessionKey for auto interaction; copy from session list"},
    "assistant_name_placeholder": {"zh": "如：小强", "en": "e.g. Assistant"},
    "assistant_name_tooltip": {"zh": "当前助手的显示名称", "en": "Current assistant display name"},
    "assistant_size_1": {"zh": "小 (1)", "en": "Small (1)"},
    "assistant_size_2": {"zh": "中 (2)", "en": "Medium (2)"},
    "assistant_size_3": {"zh": "大 (3)", "en": "Large (3)"},
    "assistant_size_tooltip": {"zh": "助手窗口体型", "en": "Assistant window size"},
    ...
    "auto_interaction_session_warn": {"zh": "已勾选「自动互动任务」时请填写自动交互 sessionKey（如 agent:work:claw_assistant）。\n可在会话管理窗口选中会话后右键「复制 sessionKey」。", "en": "When auto interaction is enabled, fill in sessionKey (e.g. agent:work:claw_assistant).\nCopy from session list via right-click."},
    ...
    "assistant_working": {"zh": "正在工作中", "en": "Working"},
    ...
    "log_main": {"zh": "主程序 (assistant_YYYYMMDD.log)", "en": "Main (assistant_YYYYMMDD.log)"},
    ...
    "model_provider_not_found_fmt": {"zh": "未找到该模型对应的 provider 配置：model_key=%s，查找的 provider_key=%s。config.models.providers 中无此 key，或 Gateway 未下发该段配置。", "en": "Provider config not found: model_key=%s, provider_key=%s (key not in config.models.providers or not returned by Gateway)."},
